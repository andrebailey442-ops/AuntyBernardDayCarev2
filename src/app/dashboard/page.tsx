...
import { GraduationCap, Sunset, Baby, UserCog } from 'lucide-react';
        ...
        <div className="grid w-full max-w-6xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2">
            ...
            <Card className="flex flex-col backdrop-blur-sm bg-card/80">
                <CardHeader className="text-center">
                    ...
                    <CardDescription>Handle check-in, check-out, and activities for the nursery program.</CardDescription>
                </CardHeader>
                <CardContent className="flex flex-1 flex-col justify-end">
                    <Link href="/dashboard/nursery" className="w-full">
                        <Button variant="outline" className="w-full border-purple-500 text-purple-500 hover:bg-purple-500/10 hover:text-purple-600">Go to Nursery Dashboard</Button>
                    </Link>
                </CardContent>
            </Card>
            <Card className="flex flex-col backdrop-blur-sm bg-card/80">
                <CardHeader className="text-center">
                    ...
                    <CardDescription>Manage staff members, schedules, and attendance.</CardDescription>
                </CardHeader>
                <CardContent className="flex flex-1 flex-col justify-end">
                    <Link href="/dashboard/staff" className="w-full">
                        <Button variant="outline" className="w-full border-blue-500 text-blue-500 hover:bg-blue-500/10 hover:text-blue-600">Go to Staff Section</Button>
                    </Link>
                </CardContent>
            </Card>
        </div>
